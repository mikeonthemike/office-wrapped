...
// v1.1.0 - Use randomized topBuzzword
 ...
 */
export const BuzzwordsSlide: React.FC<BuzzwordsSlideProps> = ({ buzzwords, topBuzzword, topBuzzwordCount }) => {
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="mt-4 sm:mt-8 text-center border-t border-slate-700 pt-4 sm:pt-6">
        <p className="text-lg sm:text-2xl text-slate-300 mb-1 sm:mb-2">
          You said{' '}
          <span className="font-black text-blue-400 text-2xl sm:text-4xl">&quot;{topBuzzword.toLowerCase()}&quot;</span>{' '}
